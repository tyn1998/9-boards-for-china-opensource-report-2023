...
const columnHelper = createColumnHelper<GlobalDeveloper>();
...
export const GlobalDeveloperBoard = ({ size }: RepositoryBoardProps) => {
  const data = useData<GlobalDeveloper>('https://oss.x-lab.info/frank_zsy/global_developer.json');
